...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public LinkedList<com.example.idofirdaus.firdausadinugroho_1202154378_studycase5.Model.Activity> findAll(){
        LinkedList<com.example.idofirdaus.firdausadinugroho_1202154378_studycase5.Model.Activity> listBuku = new LinkedList<com.example.idofirdaus.firdausadinugroho_1202154378_studycase5.Model.Activity>();
        ...
        if(cursor.moveToFirst()){
            do{
                com.example.idofirdaus.firdausadinugroho_1202154378_studycase5.Model.Activity activity = new com.example.idofirdaus.firdausadinugroho_1202154378_studycase5.Model.Activity();
    ...
    public boolean delete(com.example.idofirdaus.firdausadinugroho_1202154378_studycase5.Model.Activity activity){
        SQLiteDatabase db=this.getWritableDatabase();
